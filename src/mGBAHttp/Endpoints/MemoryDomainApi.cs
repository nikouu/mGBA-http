...
namespace mGBAHttp.Endpoints
{
    public static class MemoryDomainApi
    {
        public static RouteGroupBuilder MapMemoryDomainEndpoints(this IEndpointRouteBuilder routes)
        {
            ...
            {
                o.Summary = "Get the bound of the memory domain.";
                ...
                o.Parameters[0].Description = "Memory domain name (e.g., 'wram', 'cart0', 'bios', etc).";
                o.Responses["200"].Description = "Bound address as a string.";
            ...
            }).WithOpenApi(o =>
            {
                ...
                o.Responses["200"].Description = "16-bit value as a string.";
            ...
            }).WithOpenApi(o =>
            {
                ...
                o.Parameters[0].Description = "Memory domain name (e.g., 'wram', 'cart0', 'bios', etc).";
                o.Parameters[1].Description = "Address as hex string with 0x prefix (e.g., '0x0300')";
                o.Responses["200"].Description = "32-bit value as a string.";
            ...
            }).WithOpenApi(o =>
            {
                ...
                o.Parameters[0].Description = "Memory domain name (e.g., 'wram', 'cart0', 'bios', etc).";
                o.Parameters[1].Description = "Address as hex string with 0x prefix (e.g., '0x0300')";
                o.Responses["200"].Description = "8-bit value as a string.";
            ...
            }).WithOpenApi(o =>
            {
                ...
                o.Parameters[0].Description = "Memory domain name (e.g., 'wram', 'cart0', 'bios', etc).";
                o.Parameters[1].Description = "Address as hex string (e.g., '0x0300').";
            ...
            }).WithOpenApi(o =>
            {
                ...
                o.Parameters[0].Description = "Memory domain name (e.g., 'wram', 'cart0', 'bios', etc).";
                o.Responses["200"].Description = "Size in bytes as a string.";
